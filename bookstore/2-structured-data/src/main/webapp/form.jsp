...
<div class="container">
  ...
  <form method="POST" action="${destination}" enctype="multipart/form-data">
    ...
    <input type="hidden" name="bufRating" id="bufRating" value="${fn:escapeXml(book.bufRating)}" class="form-control" />

    <input type="hidden" name="comments" id="comments" value="${fn:escapeXml(book.comments)}" class="form-control" />

    <input type="hidden" name="bufComments" id="bufComments" value="${fn:escapeXml(book.bufComments)}" class="form-control" />
